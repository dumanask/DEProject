...
public class AIWaypointNetworkEditor : Editor 
{
	...
	public override void OnInspectorGUI()
	{
		...
		{
			network.UIStartPoint = EditorGUILayout.IntSlider ( "Waypoint Start" , network.UIStartPoint, 0, network.Waypoints.Count-1);
			network.UIEndPoint = EditorGUILayout.IntSlider ( "Waypoint End" , network.UIEndPoint, 0, network.Waypoints.Count-1);
		}
